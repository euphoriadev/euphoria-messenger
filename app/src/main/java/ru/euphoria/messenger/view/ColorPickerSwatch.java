...
public class ColorPickerSwatch extends FrameLayout implements View.OnClickListener {
    ...
    public ColorPickerSwatch(Context paramContext, int color, boolean checked, OnColorSelectedListener onColorSelectedListener) {
        ...
        this.mSwatchImage = ((ImageView) findViewById(R.id.colorPickerSwatch));
        this.mCheckmarkImage = ((ImageView) findViewById(R.id.colorPickerCheckmark));
        setColor(color);
        setChecked(checked);
    ...
    protected void setColor(int color) {
        ...
        this.mSwatchImage.setImageDrawable(new ColorPickerPalette.ColorStateDrawable(drawables, color));
    }
