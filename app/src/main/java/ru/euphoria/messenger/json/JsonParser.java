 ...
 * this class will use only need the {@link #JsonParser(String) constructor}
 ...
 *         + "}";
 *
 * JsonObject object = (JsonObject) new JsonParser(json).nextValue();
...
public class JsonParser {
    ...
    private Object readLiteral() throws JsonException {
        ...
        return String.valueOf(literal.toCharArray()); // a new string avoids leaking memory
    }
